---
title: "Improvement of chromVAR by normalization - simulated data"
format:
  html:
    toc: true
    code-fold: true
...
```{r visualization of devs}
# lapply(names(sim_devs), \(x) {
#     dev <- sim_devs[[x]]
#     as.ggplot(pheatmap(deviations(dev))) + ggtitle(x)
# }) |> 
...
#saveRDS(res, "../result/01_sim/old_limma.rds")
...
devtools::load_all("../../ATAC-seq/chromVAR/")
source("utils.R")
